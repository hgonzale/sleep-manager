...
class TestWakerEndpoints:
    ...
    @patch('sleep_manager.waker.subprocess.run')
    def test_wake_endpoint_failure(self, mock_run, client):
    ...
    def test_suspend_endpoint_success(self, mock_sleeper_request, client):
    ...
    @patch('sleep_manager.waker.sleeper_request')
    def test_status_endpoint_success(self, mock_sleeper_request, client):
...
class TestWakerConfiguration:
    ...
    def test_waker_url_generation(self):
...
class TestSleeperRequest:
    ...
    def test_sleeper_request_success(self, mock_get, app):
    ...
    @patch('sleep_manager.waker.requests.get')
    def test_sleeper_request_timeout(self, mock_get, app):
